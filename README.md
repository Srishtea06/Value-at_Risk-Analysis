...
3. Risk Estimation: For each decile portfolio:
 Compute VaR at 95% and 99% confidence levels using the following methods. 
 Compare risk metrics across the given methods. 
